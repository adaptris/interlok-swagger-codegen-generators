...
public class OperationParameters {
  ...
  public void parseNestedObjects(String name, Schema schema, Set<String> imports, DefaultCodegenConfig codegenConfig, OpenAPI openAPI) {
    ...
    for (String key : properties.keySet()) {
      ...
      final Parameter queryParameter = new QueryParameter().name(parameterName).required(required).schema(property);
  ...
  private boolean isObjectWithProperties(Schema schema) {
    return ("object".equalsIgnoreCase(schema.getType()) || schema.getType() == null) && schema.getProperties() != null
